...
export const ja: Partial<Record<keyof typeof en, string>> = {
  ...
  "settings.paragraphIndentMode.auto": "自動（原稿に従う）",
  "settings.paragraphIndentMode.manuscript": "原稿の全角スペースのある段落だけ",
  "settings.paragraphIndentMode.brackets": "始め括弧で始まる段落以外",
  "settings.paragraphIndentMode.all": "すべての段落",
