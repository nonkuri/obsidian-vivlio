...
export const en = {
  ...
  "settings.startSide": "Chapters and parts open on",
  "settings.startSide.any": "Wherever the text reaches",
  "settings.startSide.left": "The left page (the odd one)",
  "settings.startSide.right": "The right page (the even one)",
  ...
  "settings.startPage": "First folio number (zero and below are hidden)",
  ...
  "settings.botenMark": "Emphasis mark",
  "settings.botenMark.desc":
    "Used by both 《《emphasis》》 and ==highlight== in emphasis-dot mode. Type any mark in the field if it is not listed.",
  "settings.botenMark.sesame": "Sesame dot",
  "settings.botenMark.openSesame": "Open sesame dot",
  "settings.botenMark.dot": "Black circle",
  "settings.botenMark.openDot": "White circle",
  "settings.botenMark.triangle": "Black triangle",
  "settings.botenMark.openTriangle": "White triangle",
  "settings.botenMark.doubleCircle": "Double circle",
  "settings.botenMark.bullseye": "Bullseye",
  "settings.botenMark.custom": "Other (type at right)",
  "settings.botenMark.placeholder": "Any mark",
  "settings.botenMark.customInput": "Custom emphasis mark",
  ...
  "settings.pageNumbering.roman-then-arabic":
    "Roman numerals through the front matter, then restart in Arabic at the first chapter",
  "settings.pageNumbering.continuous": "Arabic numerals through front matter and body, excluding the cover",
  ...
  "settings.viewerSpread": "Page display mode",
  "settings.viewerSpread.single": "Single page",
  "settings.viewerSpread.spread": "Facing pages",
  "settings.viewerSpread.auto": "Automatic",
  "settings.viewerPreferences.desc": "Applies when the preview opens or rebuilds. Does not affect PDF or EPUB output.",
  "settings.viewerFitToScreen": "Fit pages to the preview pane",
  "settings.viewerZoom": "Preview zoom (%)",
  "settings.viewerZoom.desc": "10–1000%. Used when fit to screen is off; the fixed zoom is retained while fitting.",
  "settings.rememberViewerSettings": "Remember changes made in the viewer",
  "settings.rememberViewerSettings.desc": "Save page display mode and zoom/fit changes as vault-wide defaults. When off, rebuilding restores the plugin settings. Zoom outside 10–1000% is not saved.",
