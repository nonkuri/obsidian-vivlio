...
| 横書き印刷用マガジン | 段抜き見出し・二段組・裁ち落とし図版・囲みコラム。オリジナル原稿とSVG、4ページPDF付き | A4・3mm塗り足し・トンボ。独立CSS、Vivlio 0.17.3で確認 | [使い方・組見本](css/horizontal-magazine/README.md) / [CSS](css/horizontal-magazine/horizontal-magazine.css) / [一式ZIP](https://raw.githubusercontent.com/nonkuri/obsidian-vivlio/0.17.4/sample/downloads/vivlio-sample-horizontal-magazine-0.17.4.zip) |
| 縦書き印刷用マガジン | 縦三段（冒頭は図版と本文二段）・縦見出し・裁ち落とし図版・囲みコラム。オリジナル原稿とSVG、4ページPDF付き | A4・右綴じ・3mm塗り足し・トンボ。独立CSS、Vivlio 0.17.3で確認 | [使い方・組見本](css/vertical-magazine/README.md) / [CSS](css/vertical-magazine/vertical-magazine.css) / [一式ZIP](https://raw.githubusercontent.com/nonkuri/obsidian-vivlio/0.17.4/sample/downloads/vivlio-sample-vertical-magazine-0.17.4.zip) |
...
|---|---|---|---|---|
| 縦書き印刷用マガジン「余白通信」 | 右綴じ・縦三段、冒頭図版、コラム、3mm塗り足し。原稿2本・SVG4点・4ページPDF | Vault内の独立CSSを同梱 | 0.17.4以降（相対テーマ指定） | [使い方](css/vertical-magazine/README.md) / [一式ZIP](https://raw.githubusercontent.com/nonkuri/obsidian-vivlio/0.17.4/sample/downloads/vivlio-sample-vertical-magazine-0.17.4.zip) / [SHA-256](https://raw.githubusercontent.com/nonkuri/obsidian-vivlio/0.17.4/sample/downloads/vivlio-sample-vertical-magazine-0.17.4.zip.sha256) |
| 横書き印刷用マガジン「FIELD NOTES」 | 左綴じ・横二段、段抜き見出し、コラム、3mm塗り足し。原稿2本・SVG4点・4ページPDF | Vault内の独立CSSを同梱 | 0.17.4以降（相対テーマ指定） | [使い方](css/horizontal-magazine/README.md) / [一式ZIP](https://raw.githubusercontent.com/nonkuri/obsidian-vivlio/0.17.4/sample/downloads/vivlio-sample-horizontal-magazine-0.17.4.zip) / [SHA-256](https://raw.githubusercontent.com/nonkuri/obsidian-vivlio/0.17.4/sample/downloads/vivlio-sample-horizontal-magazine-0.17.4.zip.sha256) |
...
印刷用マガジン2種は0.17.4タグに固定したZIPを案内しています。0.17.4版は相対テーマ指定に対応し、フォルダ構成を保てばVault内の任意の場所へ配置できます。旧0.17.3版のZIPと既存タグは変更しません。
